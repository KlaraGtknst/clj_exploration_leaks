...
;; This file runs statistical analysis on a directory of files and creates a context from the metadata
;; Functionalities include:
;; - extracting, update & saving metadata from files in a directory to a CSV file
;; - displaying single & multivalued contexts of metadata
;; - creating & saving a file tree
;; - save statistics of metadata to .csv and .txt files
;; - creates, saves & displays dir-topic context across multiple directories (novel functionality)
...
(defn -main
  ...
  (let [file_path "/norgay/bigstore/kgu/data/ETYNTKE"]
